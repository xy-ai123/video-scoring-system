                    ...
                    <>
                      <td className="px-4 py-2">
                        ...
                        <input
                          ...
                          autoComplete="off"
                          className="mt-1 block w-full rounded-md border border-slate-300 px-2 py-1 text-xs shadow-sm focus:border-slate-700 focus:outline-none focus:ring-1 focus:ring-slate-700"
                        />
                      </td>
                      <td className="px-4 py-2">
                        <input
